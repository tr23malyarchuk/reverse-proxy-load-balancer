...
function App() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // TODO: заменить URL на реальный endpoint reverse proxy для конкретного сервиса
      let endpoint = "";
      switch (selectedService.id) {
        case "wav2mp3":
          endpoint = "/file-request"; // приклад: твій існуючий бекенд
          break;
        case "pdf2png":
          endpoint = "/pdf2png";
          break;
  ...
  return (
    <div style={styles.page}>
      <header style={styles.header}>
        <h1 style={styles.title}>File Conversion Platform</h1>
      ...
      <main style={styles.main}>
        <section style={styles.tilesSection}>
          <h2 style={styles.sectionTitle}>Доступні сервіси</h2>
        ...
        <section style={styles.formSection}>
          <h2 style={styles.sectionTitle}>Панель завантаження</h2>
          {!selectedService && (
            <p style={styles.hint}>
          ...
          {selectedService && (
            <form style={styles.form} onSubmit={handleSubmit}>
              ...
              {error && <p style={styles.error}>Помилка: {error}</p>}
